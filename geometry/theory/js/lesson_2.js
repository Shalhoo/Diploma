...
var skew_rect_1 = document.getElementsByClassName("skew_rect_1")
...
function animation_3() {
	if(done == 0) {
		...
		return start_animation(line_A_A1[0]).then(() => {
			if(!animationPaused) {
				return new Promise((resolve) => {
                    line_A2_A[0].style.setProperty('--width_1', '205');
			...
			if(!animationPaused) {
				return new Promise((resolve) => {
                    el_Z[1].style.animation = "change_opasity_1 0.5s forwards"
                    el_Z[1].style.animationDelay = "3s";
			...
			if(!animationPaused) {
				return new Promise((resolve) => {
                    el_X[0].style.animation = "change_opasity_1 0.5s forwards"
                    el_X[0].style.animationDelay = "4s";
                    resolve(start_animation(el_X[0]));
				});
			}
		}).then(() => {
			if(!animationPaused) {
...
function animation_4() {
	if(done = "animation_3 is done") {
        red_line[0].style.animation = "long_blink 3s forwards, change_opasity_1 0.5s forwards"
        red_line[0].style.animationDelay = "0.5s, 3s";
        coord_Y[0].style.animation = " change_opasity_1 0.1s forwards"
        coord_Y[0].style.animationDelay = "0s";
        coord_Y[1].style.animation = " change_opasity_1 0.1s forwards"
		...
		return start_animation(red_line[0]).then(() => {
			...
			if(!animationPaused) {
				return new Promise((resolve) => {
					el_Y[1].style.setProperty('--left_1', '190');
					el_Y[1].style.setProperty('--left_2', '168');
					el_Y[1].style.setProperty('--top_1', '175');
					el_Y[1].style.setProperty('--top_2', '205');
					el_Y[1].style.animation = "change_left_top 2s forwards"
					el_Y[1].style.animationDelay = "3.5s";
			...
			if(!animationPaused) {
				return new Promise((resolve) => {
					coord_Y[2].style.setProperty('--left_1', '360');
					coord_Y[2].style.setProperty('--left_2', '295');
					coord_Y[2].style.setProperty('--top_1', '225');
					coord_Y[2].style.setProperty('--top_2', '300');
					coord_Y[2].style.animation = "change_left_top 2s forwards"
					coord_Y[2].style.animationDelay = "3.5s";
                    resolve(start_animation(coord_Y[2]));
				});
			}
		}).then(() => {
			if(!animationPaused) {
				return new Promise((resolve) => {
					coord_Y[3].style.setProperty('--left_1', '366');
					coord_Y[3].style.setProperty('--left_2', '301');
					coord_Y[3].style.setProperty('--top_1', '135');
					coord_Y[3].style.setProperty('--top_2', '210');
					coord_Y[3].style.animation = "change_left_top 2s forwards"
					coord_Y[3].style.animationDelay = "3.5s";
                    resolve(start_animation(coord_Y[3]));
				});
			}
		}).then(() => {
			if(!animationPaused) {
				return new Promise((resolve) => {
                    red_line[1].style.animation = "long_blink 3s forwards, change_opasity_1 0.5s forwards"
					red_line[1].style.animationDelay = "5.5s, 8s";
				...
				if(!animationPaused) {
					return new Promise((resolve) => {
						skew_rect_1[0].style.animation = "transform-to-square1 2s forwards"
						skew_rect_1[0].style.animationDelay = "8.5s";
						resolve(start_animation(skew_rect_1[0]));
					});
				}
			}).then(() => {
				if(!animationPaused) {
					return new Promise((resolve) => {
						c_A3[0].style.setProperty('--left_1', '125');
						c_A3[0].style.setProperty('--left_2', '180');
						c_A3[0].style.setProperty('--top_1', '0');
						c_A3[0].style.setProperty('--top_2', '-30');
						c_A3[0].style.animation = "change_left_top 2s forwards"
						c_A3[0].style.animationDelay = "8.5s";
						resolve(start_animation(c_A3[0]));
					});
				}
			}).then(() => {
				if(!animationPaused) {
					return new Promise((resolve) => {
						el_A3[0].style.setProperty('--left_1', '325');
						el_A3[0].style.setProperty('--left_2', '380');
						el_A3[0].style.setProperty('--top_1', '90');
						el_A3[0].style.setProperty('--top_2', '60');
						el_A3[0].style.animation = "change_left_top 2s forwards"
						el_A3[0].style.animationDelay = "8.5s";
						resolve(start_animation(el_A3[0]));
					});
				}
			}).then(() => {
				if(!animationPaused) {
					return new Promise((resolve) => {
						el_P3[0].style.setProperty('--left_1', '325');
						el_P3[0].style.setProperty('--left_2', '405');
						el_P3[0].style.setProperty('--top_1', '60');
						el_P3[0].style.setProperty('--top_2', '30');
						el_P3[0].style.animation = "change_left_top 2s forwards"
						el_P3[0].style.animationDelay = "8.5s";
						resolve(start_animation(el_P3[0]));
					});
				}
			}).then(() => {
				if(!animationPaused) {
					return new Promise((resolve) => {
						el_Y[0].style.setProperty('--left_1', '310');
						el_Y[0].style.setProperty('--left_2', '350');
						el_Y[0].style.setProperty('--top_1', '75');
						el_Y[0].style.setProperty('--top_2', '60');
						el_Y[0].style.animation = "change_left_top 2s forwards"
						el_Y[0].style.animationDelay = "8.5s";
				...
				if(!animationPaused) {
					return new Promise((resolve) => {
						coord_Y[4].style.setProperty('--left_1', '360');
						coord_Y[4].style.setProperty('--left_2', '435');
						coord_Y[4].style.setProperty('--top_1', '225');
						coord_Y[4].style.setProperty('--top_2', '170');
						coord_Y[4].style.animation = "change_left_top 2s forwards"
						coord_Y[4].style.animationDelay = "8.5s";
						resolve(start_animation(coord_Y[4]));
					});
				}
			}).then(() => {
				if(!animationPaused) {
					return new Promise((resolve) => {
						coord_Y[5].style.setProperty('--left_1', '368');
						coord_Y[5].style.setProperty('--left_2', '440');
						coord_Y[5].style.setProperty('--top_1', '134');
						coord_Y[5].style.setProperty('--top_2', '78');
						coord_Y[5].style.animation = "change_left_top 2s forwards"
						coord_Y[5].style.animationDelay = "8.5s";
						resolve(start_animation(coord_Y[5]));
					});
				}
			}).then(() => {
				if(!animationPaused) {
...
function animation_8() {
	if(done = "animation_7 is done") {
		...
		c_A2[0].style.setProperty('--top_1', '90');
		c_A2[0].style.setProperty('--top_2', '0');
		c_A2[0].style.animation = "change_top 2s forwards,blink 2s forwards"
		c_A2[0].style.animationDelay = "0.5s, 3.5s";
		return start_animation(c_A2[0]).then(() => {
			if(!animationPaused) {
				return new Promise((resolve) => {
			...
			if(!animationPaused) {
				return new Promise((resolve) => {
					el_25[0].style.animation = "long_blink 3s forwards"
					el_25[0].style.animationDelay = "2.5s";
			...
			if(!animationPaused) {
				return new Promise((resolve) => {
					el_20[0].style.animation = "long_blink 3s forwards"
					el_20[0].style.animationDelay = "2.5s";
			...
			if(!animationPaused) {
				return new Promise((resolve) => {
					el_A2[0].style.animation = "long_blink 3s forwards"
					el_A2[0].style.animationDelay = "5.5s";
                    resolve(start_animation(el_A2[0]));
				});
			}
		}).then(() => {
			if(!animationPaused) {
...
function animation_9() {
	if(done = "animation_8 is done") {
        line_A2_A3[0].style.setProperty('--width_1', '40');
        line_A2_A3[0].style.setProperty('--width_2', '221');
		line_A2_A3[0].style.animation = "change_width 2s forwards"
        line_A2_A3[0].style.animationDelay = "0.5s";
		return start_animation(line_A2_A3[0]).then(() => {
			if(!animationPaused) {
				return new Promise((resolve) => {
				c_A3[1].style.animation = "blink 2s forwards, long_blink 3s forwards"
				c_A3[1].style.animationDelay = "2.5s, 10s";
				resolve(start_animation(c_A3[1]));
				});
			}
		}).then(() => {
			if(!animationPaused) {
				return new Promise((resolve) => {
				el_A3[1].style.animation = "blink 2s forwards, long_blink 3s forwards"
				el_A3[1].style.animationDelay = "2.5s, 10s";
				resolve(start_animation(el_A1[1]));
				});
			}
		}).then(() => {
			if(!animationPaused) {
				return new Promise((resolve) => {
				el_25[1].style.animation = "blink 2s forwards, change_opasity_1 0.5s forwards"
				el_25[1].style.animationDelay = "4.5s, 9s";
				resolve(start_animation(el_25[1]));
				});
			}
		}).then(() => {
			if(!animationPaused) {
				...
				white_rect[0].style.animationDelay = "6.5s";
			...
			if(!animationPaused) {
				return new Promise((resolve) => {
				el_25[0].style.animation = "change_opasity_1 0.5s forwards"
				el_25[0].style.animationDelay = " 9s";
				resolve(start_animation(el_25[0]));
				});
			}
		}).then(() => {
			if(!animationPaused) {
				return new Promise((resolve) => {
				el_20[0].style.animation = "change_opasity_1 0.5s forwards"
				el_20[0].style.animationDelay = " 9s";
				resolve(start_animation(el_20[0]));
				});
			}
		}).then(() => {
			if(!animationPaused) {
				return new Promise((resolve) => {
					el_A1[1].style.animation = "long_blink 3s forwards"
					el_A1[1].style.animationDelay = "10s";
                    resolve(start_animation(el_A1[1]));
				});
			}
		}).then(() => {
			if(!animationPaused) {
				return new Promise((resolve) => {
					c_A1[1].style.animation = "long_blink 3s forwards"
					c_A1[1].style.animationDelay = "10s";
                    resolve(start_animation(c_A1[1]));
				});
			}
		}).then(() => {
			if(!animationPaused) {
				return new Promise((resolve) => {
					red_line[2].style.animation = "long_blink 3s forwards"
					red_line[2].style.animationDelay = "10s";
			...
			if(!animationPaused) {
				...
				if(!animationPaused) {
					return new Promise((resolve) => {
						start.style.animation = "change_display 0.1s forwards"
						start.style.animationDelay = "13s";
						resolve(start_animation(start));
				});
			}
		})
